...
Uses python 3.11, no other packages required
...
Union-find approach merge circuits as connections are added
...
Joltages!!
a) Powerset
b) Reduce equations using row echelon form to form a narrower set of possibilities
...
Taskmaster packing problem - not a problem if you so some basic sanity checks first (slap face)
